...
class HomeScreen extends ConsumerWidget {
  ...
  static final List<_QuickAction> _quickActions = [
    ...
    _QuickAction(Icons.image_rounded, 'Image to PDF', (c) => c.showComingSoon('Image to PDF')),
    _QuickAction(Icons.call_merge_rounded, 'Merge PDF', (c) => c.showComingSoon('Merge PDF')),
    _QuickAction(Icons.call_split_rounded, 'Split PDF', (c) => c.showComingSoon('Split PDF')),
    _QuickAction(Icons.compress_rounded, 'Compress PDF', (c) => c.showComingSoon('Compress PDF')),
